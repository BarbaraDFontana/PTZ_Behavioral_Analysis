...
Script 5. RF output for all the data, saving individual values for time analysis and summary data for overall values. Bring up the IDs so the info of every fish, such as sex, age etc, are presented. Post-processing is included in this script. Summary of the data overall values are found in the main folder

Functions used to calculate projections are also here

Original full data can be accessed upon request (data of the 128 animals)
