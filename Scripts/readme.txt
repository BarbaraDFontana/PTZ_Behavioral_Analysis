...
Script 5. RF output for all the data, saving individual values for time analysis and summary data for overall values. Bring up the IDs so the info of every fish, such as sex, age etc, are presented.
